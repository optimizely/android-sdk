 ...
 */ private constructor(private val context: Context) : EventHandler {
    ...
    override fun dispatchEvent(logEvent: LogEvent) {
        ...
        intent.putExtra(EventIntentService.Companion.EXTRA_URL, logEvent.endpointUrl)
        intent.putExtra(EventIntentService.Companion.EXTRA_REQUEST_BODY, logEvent.body)
        intent.putExtra(EventIntentService.Companion.EXTRA_INTERVAL, dispatchInterval)
        ServiceScheduler.startService(context, EventIntentService.Companion.JOB_ID, intent)
