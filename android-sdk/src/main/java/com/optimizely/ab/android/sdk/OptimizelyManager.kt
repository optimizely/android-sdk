...
constructor(projectId: String?,
            ...
            defaultDecideOptions: List<OptimizelyDecideOption>?) {
    ...
    private val defaultDecideOptions: List<OptimizelyDecideOption>?
    ...
    private fun startDatafileHandler(context: Context) {
        ...
        datafileHandler.startBackgroundUpdates(context, datafileConfig, datafileDownloadInterval, object : DatafileLoadedListener {
            override fun onDatafileLoaded(dataFile: String?) {
    ...
    fun injectOptimizely(context: Context, userProfileService: UserProfileService,
        ...
        try {
            ...
            startDatafileHandler(context)
            if (userProfileService is DefaultUserProfileService) {
                userProfileService.startInBackground (
                    object : DefaultUserProfileService.StartCallback {
    ...
    private fun buildOptimizely(context: Context, datafile: String): OptimizelyClient {
        ...
        val clientEngine = getClientEngineFromContext(context)
    ...
    class Builder {
        ...
        private var defaultDecideOptions: List<OptimizelyDecideOption>? = null
        ...
        fun withDefaultDecideOptions(defaultDecideOptions: List<OptimizelyDecideOption>?): Builder {
...
//                }
            ...
            if (userProfileService == null) {
                userProfileService = DefaultUserProfileService.newInstance(datafileConfig!!.key, context!!)
            }
            if (eventHandler == null) {
