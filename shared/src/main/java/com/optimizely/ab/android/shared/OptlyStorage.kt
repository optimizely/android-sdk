 ...
 */(private val context: Context) {
    ...
    private val writablePrefs: Editor
        private get() = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE).edit()
    private val readablePrefs: SharedPreferences
        private get() = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)

    companion object {
        private const val PREFS_NAME = "optly"
    }
}